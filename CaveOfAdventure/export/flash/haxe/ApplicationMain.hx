...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("LudumDare34Game", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("LudumDare34Game", null, 640, 480);
		#end
		#else
		create (null);
		#end
		...
		var projectName = "LudumDare34Game";
		
		var config = {
			
			build: "600",
			company: "HaxeFlixel",
			file: "LudumDare34Game",
			fps: 60,
			name: "LudumDare34Game",
			orientation: "",
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "LudumDare34Game";
		app.meta["name"] = "LudumDare34Game";
